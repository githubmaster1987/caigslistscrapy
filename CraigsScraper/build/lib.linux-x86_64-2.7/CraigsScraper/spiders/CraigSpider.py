...
class CraigspiderSpider(scrapy.Spider):
    ...
    input_file = "items_CraigSpider_5.csv"
    output_file_without_duplication = "without_duplication_5.csv"
    ...
    def start_requests(self):
        ...
        # req = self.set_proxies(self.start_urls[0] + '/search/sss?query=' + self.keywords[0], self.duplication_check)
        # yield req
